...
// Welcome show summary of current Tobe instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Tobe JavaScript console!\n\n"

	// Print some generic Tobe metadata
